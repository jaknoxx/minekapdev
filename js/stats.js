...
function updateStatsDisplay(players) {
    ...
    document.getElementById('topPlayerName').textContent = topPlayer;
    document.getElementById('avgPoints').textContent = avgPoints;
    document.getElementById('highestTier').innerHTML = `<span class="tier-badge tier-${highestTier}">${highestTier}</span>`;
}
